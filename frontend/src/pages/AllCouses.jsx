/**
 * ============================================
 * ALL COURSES - Browse & Filter Courses
 * ============================================
 * Gets courseData from Redux. Sidebar: category checkboxes (App Dev, AI/ML, etc.)
 * applyFilter: Filters courses by selected categories
 * "Search with AI" → /searchwithai
 */
  ...
  return (
    <div className="flex min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <button
        ...
        className="fixed top-20 left-4 z-50 bg-slate-900 text-[var(--text)] px-3 py-1 rounded md:hidden border border-[var(--border)]"
      >
