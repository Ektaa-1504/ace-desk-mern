/**
 * ReviewPage - "Real Reviews from Real Learners" section on Home
 * Gets allReview from Redux, shows first 6 via ReviewCard
 */
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      <span className="lg:w-[50%] md:w-[80%] text-[18px] text-center mt-[30px] mb-[30px] px-[20px]">
        Discover how AceDesk is transforming learning experiences through real
