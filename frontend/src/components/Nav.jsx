 ...
 * ============================================
 * Shows logo, profile/avatar, Login/Logout, Dashboard (for educators).
 * Uses useSelector to read userData - if null, shows Login; if logged in, shows avatar + Logout.
 * handleLogout: GET /api/auth/logout clears session cookie, then dispatch(setUserData(null))
 */
...
function Nav() {
  ...
  // Logout: backend clears HTTP-only cookie, we clear Redux userData
  ...
  return (
    <div>
      <div className="w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-gradient-to-b from-black/60 to-black/10 backdrop-blur-md z-10">
